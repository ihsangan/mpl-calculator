                ...
                {standings.map((team, idx) => {
                  ...
                  return (
                    <TableRow key={team.id} className={rowBg}>
                      ...
                      <TableCell className="py-3 text-center text-sm font-semibold tabular-nums">
                        {team.matchW}–{team.matchL}
                      </TableCell>
                      <TableCell className="py-3 text-center text-sm font-medium text-muted-foreground tabular-nums">
                        {team.gameW}–{team.gameL}
                      </TableCell>
                      <TableCell
                        className={`py-3 text-center text-sm font-bold tabular-nums ${getWinrateClass(
                          team.winrate
                        )}`}
                      >
                        {team.winrate}%
                      ...
                      <TableCell
                        className={`py-3 text-center text-sm font-bold tabular-nums ${getDiffClass(
                          team.diff
                        )}`}
                      >
